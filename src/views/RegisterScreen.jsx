...
function RegisterScreen() {
    ...
    const [vectorUsuarios, setVectorUsuarios] = useState(JSON.parse(localStorage.getItem("usuarios")) || [
        {
            nombre: "admin",
            ...
            <div className="row vh-100 align-items-center">
                <div className="col-12 col-md-6 offset-md-3 p-3 registro-contenedor rounded shadow">
                    ...
                    <div className="text-center registro-titulo mb-3">
                        ...
                        {mensaje && (<p className="text-center text-danger">El correo ya pertenece a una cuenta existente</p>)}
                    </div>
                    <form onSubmit={handleSubmit(cargarUsuario)} noValidate>

                        <div className="mt-3">
                            <label className="form-label registro-label">Nombre</label>
                            <input className="form-control" type="text" id="nombre" {...register("nombre", {
                        ...
                        <div className="mt-3">
                            ...
                            <input className="form-control" type="password" id="password" {...register("password", {
                                ...
                                pattern: {
                                    ...
                                    message: "La contraseña no es valida. Debe tener mínimo una mayúscula y un dígito"
                                }
                            })} />
                        ...
                        <div className="d-grid mt-3">
                            <button className="btn registro-boton" type="submit">Crear cuenta</button>
                        </div>
                    </form>
                </div>
            </div>
