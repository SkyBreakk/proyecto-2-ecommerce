      ...
      if (posicion != -1) {
        if (usuarios[posicion].password === data.password) {
          ...
          logIn(
            ...
            usuarios[posicion].password,
            usuarios[posicion].rol
          );
          onClose();
        } else {
          setMensajePass(true);
      ...
      <div className="modal-container" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          >
            ...
            {mensaje && (
              <p className="text-danger text-center">La cuenta no existe</p>
            )}
            {mensajePass && (
              <p className="text-danger text-center">Contraseña incorrecta</p>
            )}
