...
function ProductoEnLista({ producto, borrarProducto, updateDataProduct }) {
  ...
  return (
    <tr>
      ...
      <td className="d-none d-lg-table-cell">{producto.category}</td>
      <td className="d-none d-md-table-cell">{producto.price}</td>
      <td>
        <div className="container d-flex align-items-center gap-2">
          <button
            className="btn admin-editar-producto btn-sm"
            onClick={() => {
          ...
          <button
            className="btn admin-borrar-producto btn-sm"
            onClick={() => {
